...
public class QuestionnaireManager : MonoBehaviour
{
  ...
  /// </summary>
  [SerializeField]
  [Header("Total question in a questionnaire")]
  ...
  /// </summary>
  [SerializeField]
  [Header("Max time to solve a questions")]
  private float maxValue = 5f;

  [SerializeField]
  [Header("Min coins to take hint")]
  ...
  void AnswerResponse(bool isCorrect)
  {
    ...
    if (isCorrect)
    {
      ...
      // points logic
      // granting points on the base of time user answered
      pointsOfOneQuestion = (int)(maxValue - CurrentValue);
      totalPoints += pointsOfOneQuestion;
